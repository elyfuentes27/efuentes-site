      ...
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
        <div>
          <p className='uppercase text-xs tracking-widest text-light-gray py-10 '>
            People don't care about what you say, <br /> they care about what
            you build. -{' '}
            <a
          ...
          <p className='py-4 text-light-gray max-w-[70%] m-auto'>
            I'm a Software Engineer with a demonstrated history of working in
            the computer software industry. Strong engineering professional with
            a Bachelor's degree focused in Computer Science. Specializing in
            Building exceptional digital experience.
          </p>
